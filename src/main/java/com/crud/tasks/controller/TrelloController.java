...
public class TrelloController {
    ...
    public CreatedTrelloCard createTrelloCard(@RequestBody TrelloCardDto trelloCardDto, BadgesDto badgesDto) {
        return trelloClient.createNewCard(trelloCardDto,badgesDto);
    }
}
